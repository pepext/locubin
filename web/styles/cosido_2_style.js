var size = 0;
var placement = 'point';
function categories_cosido_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
var style_cosido_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_cosido_2(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
